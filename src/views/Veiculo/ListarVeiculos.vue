<template >
    ...
    <div class="container">
      <div class="d-flex justify-center align-items-center bg-dark">
        ...
        <div class="col-2">
          <router-link to="/Adicionar-Veiculo" class="btn btn-success  " >
        ...
        <tbody>
          ...
          <tr v-for="veiculo in veiculoLista" :key="veiculo.id" scope="row">
            ...
            <td>
              ...
              <router-link class="btn btn-editar" :to="{ name: 'Adicionar-Veiculo-editar', query: { id: veiculo.id, form: 'editar' } } ">
            ...
            <td >
              <router-link class="btn btn-excluir" :to="{ name: 'Adicionar-Veiculo-excluir', query: { id: veiculo.id, form: 'excluir' } } ">
