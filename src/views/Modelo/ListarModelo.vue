<template>
    ...
    <div class="container">
          <div class="d-flex justify-center align-items-center bg-dark">
            ...
            <div class="col-2">
              <router-link to="/Adicionar-Modelo" class="btn btn-success  " >
          ...
          <table class="table table-bordered table-dark">
            ...
            <tbody>
              ...
              <tr v-for="item in modeloLista" :key="item.id" scope="row">
                ...
                <td>
                  <router-link class="btn btn-editar" :to="{ name: 'Adicionar-Modelo-editar', query: { id: item.id, form: 'editar' } } "> 
                ...
                <td >
                  <router-link class="btn btn-excluir" :to="{ name: 'Adicionar-Modelo-excluir', query: { id: item.id, form: 'excluir' } } "> 
